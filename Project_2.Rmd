...
```{r}
qplot(LandAverageTemperature, Year, data=GlobalTemp, main="Global Temperature 1753-2013", 
      xlab="Year", ylab="Degrees (Fahrenheit)",
      geom=c("point","smooth"))+ aes(colour = Year) + scale_color_gradient(low="blue", high="red")
