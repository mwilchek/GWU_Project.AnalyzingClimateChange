...
US_West <- AvgCity[which(AvgCity =='Phoenix' | AvgCity =='Denver' | AvgCity =='Los Angeles'|
                           AvgCity =='Seattle' | AvgCity =='Las Vegas'),]
US_Midwest <- AvgCity[which(AvgCity =='Chicago' | AvgCity =='Omaha' | AvgCity =='Detroit'),]
US_Northeast <- AvgCity[which(AvgCity =='New York' | AvgCity =='Boston' | AvgCity =='Pittsburgh'),]
US_South <- AvgCity[which(AvgCity =='Miami' | AvgCity =='Washington' | AvgCity =='Houston'|
                            AvgCity =='Atlanta'),]
