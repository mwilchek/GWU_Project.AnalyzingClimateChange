...
AvgGlobal_1975 <- aggregate(GlobalTemp_1975$LandAverageTemperature, 
                            ...
                            FUN=mean)
qplot(Group.1, x, data=AvgGlobal_1975, main="Global Average Annual Temperature 1900-2013",
      xlab="Year", ylab="Degrees (Celius)",
      geom=c("point","smooth"))+ stat_smooth(method = "lm", col = "red") + aes(colour = x) + scale_color_gradient(low="blue", high="red")
